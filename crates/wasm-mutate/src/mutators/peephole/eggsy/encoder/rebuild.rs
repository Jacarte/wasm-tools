        ...
        match event {
            ...
            TraversalEvent::Exit => {
                ...
                let sub_expr_id = match term {
                    ...
                    Lang::F32Load(_) => expr.add(Lang::F32Load([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::F64Load(_) => expr.add(Lang::F64Load([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I32Load8S(_) => expr.add(Lang::I32Load8S([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I32Load8U(_) => expr.add(Lang::I32Load8U([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I32Load16S(_) => expr.add(Lang::I32Load16S([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I32Load16U(_) => expr.add(Lang::I32Load16U([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I64Load8S(_) => expr.add(Lang::I64Load8S([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I64Load8U(_) => expr.add(Lang::I64Load8U([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I64Load16S(_) => expr.add(Lang::I64Load16S([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I64Load16U(_) => expr.add(Lang::I64Load16U([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I64Load32S(_) => expr.add(Lang::I64Load32S([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::I64Load32U(_) => expr.add(Lang::I64Load32U([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ])),
                    Lang::F32Store(_) => expr.add(Lang::F32Store([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ...
                    Lang::F64Store(_) => expr.add(Lang::F64Store([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ...
                    Lang::I32Store8(_) => expr.add(Lang::I32Store8([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ...
                    Lang::I32Store16(_) => expr.add(Lang::I32Store16([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ...
                    Lang::I64Store8(_) => expr.add(Lang::I64Store8([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ...
                    Lang::I64Store16(_) => expr.add(Lang::I64Store16([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
                    ...
                    Lang::I64Store32(_) => expr.add(Lang::I64Store32([
                        operand(0),
                        operand(1),
                        operand(2),
                        operand(3),
